...
class CompanyController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'company_email.email' => 'Invalid email format',
            'company_phone.regex' => 'Invalid phone number format',
        ...
        try {
            ...
            $oldLogoPath = $companySetting->logo;
            ...
            if ($request->hasFile('logo')) {
                ...
                $companySetting->logo = $newLogoPath;
            }
            ...
            $companySetting->invoice_prefix = $request->invoice_prefix;
            $companySetting->invoice_footer = $request->invoice_footer;
            $companySetting->tin = $request->tin;
            $companySetting->currency = $request->currency;
            $companySetting->currency_symbol = $request->currency_symbol;
